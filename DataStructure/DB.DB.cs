...
namespace DataStructure
{
    ...
    public partial class DB : DbContext
    {
        ...
        private void UserMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<User>().Property(x => x.Password).HasColumnName(@"Password").IsRequired().ValueGeneratedNever();
        ...
        {
            modelBuilder.Entity<User>().HasOne(x => x.Rank).WithMany(op => op.Users).HasForeignKey(@"RankID").IsRequired(false);
            modelBuilder.Entity<User>().HasMany(x => x.LOAs).WithOne(op => op.User).OnDelete(DeleteBehavior.SetNull).HasForeignKey(@"UserID").IsRequired(true);
            ...
            modelBuilder.Entity<User>().HasMany(x => x.Operations).WithMany(op => op.Users);

            modelBuilder.Entity<Rank>().HasMany(x => x.Users).WithOne(op => op.Rank).HasForeignKey(@"RankID").IsRequired(false);

            modelBuilder.Entity<LOA>().HasOne(x => x.User).WithMany(op => op.LOAs).OnDelete(DeleteBehavior.SetNull).HasForeignKey(@"UserID").IsRequired(true);
